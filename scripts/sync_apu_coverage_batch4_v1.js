...
const startMarker = "  /* ═══ COBERTURA COMERCIAL — LOTE FINAL ═══ */";
const endMarker = "  {id:31001, tipo:";
const start = app.indexOf(startMarker);
const end = app.indexOf(endMarker, start);
if (start < 0 || end < 0) throw new Error("Bloque canónico del lote final no encontrado");
const block = app.slice(start, end).trimEnd();

for (let id = 40301; id <= 40317; id += 1) {
...
console.log(`Coverage batch 4 synchronized: ${bundlePath}`);
