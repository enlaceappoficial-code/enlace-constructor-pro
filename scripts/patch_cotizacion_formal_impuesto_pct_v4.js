...
chunk = chunk.replace(
  '["Subtotal Neto",I(g)]',
  '[(typeof ie!=="undefined"&&ie==="mo")?"Subtotal Mano de Obra":"Subtotal Neto",I(g)]'
);

chunk = chunk.replaceAll(
  "Math.round(((r&&r.iva)||.19)*100)",
  "(r&&r.moneda&&r.moneda.impuesto!==void 0?Math.round(r.moneda.impuesto):Math.round(((r&&r.iva)||.19)*100))"
);
...
console.log("OK patch_cotizacion_formal_impuesto_pct_v4");
