...
const startMarker = "  /* ═══ COBERTURA COMERCIAL — ÁREAS EXTERIORES Y PISCINAS ═══ */";
const endMarker = "  {id:31001, tipo:";
const start = app.indexOf(startMarker);
const end = app.indexOf(endMarker, start);
if (start < 0 || end < 0) throw new Error("Bloque canónico del lote 3 no encontrado");
const block = app.slice(start, end).trimEnd();

for (let id = 40201; id <= 40223; id += 1) {
...
console.log(`Coverage batch 3 synchronized: ${bundlePath}`);
