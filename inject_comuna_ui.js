...
const targetUI = `e.jsx("div",{style:{fontSize:11,color:th.muted,fontWeight:700,marginBottom:4,textTransform:"uppercase",letterSpacing:".05em"},children:"1. Regi\\\\u00F3n"}),
...
const replaceUI = `e.jsx("div",{style:{fontSize:11,color:th.muted,fontWeight:700,marginBottom:4,textTransform:"uppercase",letterSpacing:".05em"},children:"1. Regi\\\\u00F3n"}),
...
if (c.includes('children:"1. Regi\\u00F3n"')) {
    c = c.replace(/e\.jsx\("div",\{style:\{fontSize:11,color:th\.muted,fontWeight:700,marginBottom:4,textTransform:"uppercase",letterSpacing:"\.05em"\},children:"1\. Regi\\u00F3n"\}\),\s*e\.jsx\("select",\{style:d\(\{\},sty\.inp\),value:region,onChange:function\(ev\)\{setRegion\(ev\.target\.value\)\},children:regiones\.map\(function\(r\)\{return e\.jsx\("option",\{value:r,children:r\},r\)\}\)\}\)\s*\]\}\),/, replaceUI);
    console.log('UI injected');
}

// Renumber Organismo and Palabras Clave
