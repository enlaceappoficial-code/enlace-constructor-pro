...
const targetStr = `         e.jsxs("div",{style:{display:"flex",width:"100%",borderBottom:"1px solid "+th.border},children:[
...
if (c.includes(targetStr)) {
    ...
    console.log("Target string not found! Outputting the file snippet around setDetailTab:");
    const start = c.indexOf("setDetailTab");
    console.log(c.substring(Math.max(0, start - 500), start + 500));
}
