...
applyRegex(
  /children:"Todos los planes[^"]*"/,
  'children:"Planes: Starter (pago único) · Básico/Constructor/Pro/Plus (anual) · Pro Cloud (mensual)"'
);
...
console.log(`OK: planes actualizados (v2) (${changed} cambios).`);
