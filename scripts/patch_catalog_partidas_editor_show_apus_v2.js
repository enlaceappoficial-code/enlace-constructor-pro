...
function replaceOnceRegex(re, replace) {
  const m = s.match(re);
  if (!m) return false;
...
console.log("OK: bloque APUs en editor de Partida aplicado (regex).");
